...
#define OTA_FW_URL  "https://github.com/GabeMx5/ESP32-C3-Ringlight/releases/latest/download/firmware.bin"
#define OTA_FS_URL  "https://github.com/GabeMx5/ESP32-C3-Ringlight/releases/latest/download/filesystem.bin"
